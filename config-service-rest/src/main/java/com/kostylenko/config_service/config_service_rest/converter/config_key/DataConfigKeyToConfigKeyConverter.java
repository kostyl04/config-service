...
@Component
public class DataConfigKeyToConfigKeyConverter extends BaseConverter<ConfigKey, com.kostylenko.config_service.config_service_rest.domain.model.ConfigKey> {
    @Override
